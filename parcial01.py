""" tilizando TADs programamos un juzgado de faltas. Del juzgado se conoce el número de juzgado, dirección, juez a cargo y las multas pertenecientes a ese juzgado. De cada multa se conoce número de acta, dominio, fecha emisión, importe, fecha de vencimiento, código QR.

Definir la función buscar_multa la cuál recibe dos parámetros, un juzgado y un dominio, que retorna las multas por su dominio 
Resolver usando TADs y programacion estructurada
"""
